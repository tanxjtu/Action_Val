...
parser.add_argument('--batch_size', default=160, type=int, help='5 for every GPU (NVIDIA 1080Ti)')
...
# net info
parser.add_argument('--model_pth', default='../model/4901.pth', metavar='DIR to save pth')
